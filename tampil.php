...
<div class="p-3 mb-2 bg-dark text-white" style="height: 1000px;">
    ...
    <body>
        ...
        <table class="table table-hover table-dark">
            ...
            <?php 
                    ...
                    while($siswa = mysqli_fetch_array($query)){
                        ...
                        echo "<a class='btn btn-outline-danger mx-1 btn-xs' href='hapus.php?id=".$siswa['Kode']."'>Hapus</a>";
                        echo "<td>";
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-end mx-5">
            <a id="input" class="btn btn-outline-light mx-auto" style="width: 200px;" href="inputdata.php" text-decoration = "none" text-align="center">Input data baru</a>
        </div>
